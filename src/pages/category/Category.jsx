                ...
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
                        {category.map(category => (
                            <div key={category.id} className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700  font-poppins shadow-lg">
