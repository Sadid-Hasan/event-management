    ...
    <div class="container px-4 py-16 mx-auto lg:flex lg:items-center lg:justify-between">
        ...
        <div class="mt-8 lg:mt-0">
            <div class="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:-mx-2">
                ...
                <button class="px-6 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-purple-600 rounded-lg focus:ring focus:ring-blue-300 focus:ring-opacity-80 fo sm:mx-2 hover:bg-purple-500 focus:outline-none focus:bg-purple-500">
                    Get Started
                </button>
            </div>
